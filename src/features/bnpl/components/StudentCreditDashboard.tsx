  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-[#1E1E1E] rounded-xl shadow-z p-5">
        ...
        <div className="bg-white dark:bg-[#1E1E1E] rounded-xl shadow-z p-5">
          ...
          <div className="w-full bg-zgray dark:bg-[#2A2A2A] rounded-full h-2 mt-2">
            <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#1E1E1E] rounded-xl shadow-z p-6">
                  ...
                  <div
                    ...
                    className={`p-3 rounded-xl border ${
                      isOverdue
                        ...
                        : 'border-zborder dark:border-[#2A2A2A]'
                    }`}
                  >
          ...
          {overdueAmount > 0 && (
            <div className="mt-4 p-3 bg-red-50 dark:bg-red-950/20 rounded-xl border border-red-200 dark:border-red-900/50">
              <div className="flex items-center gap-2">
                <AlertTriangle className="w-4 h-4 text-zred shrink-0" />
                <div>
                  <p className="text-sm font-semibold text-red-700 dark:text-red-400">Overdue Amount</p>
        ...
        {recentTransactions.length === 0 ? (
          ...
          <div className="space-y-2">
            {recentTransactions.map((tx) => (
              <div key={tx.id} className="flex items-center justify-between py-2.5 border-b border-zborder dark:border-[#2A2A2A] last:border-0">
                <div className="flex items-center gap-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    tx.type === 'purchase' ? 'bg-red-100 dark:bg-red-900/30' :
                    tx.type === 'repayment' ? 'bg-green-100 dark:bg-green-900/30' :
                    tx.type === 'fee' ? 'bg-yellow-100 dark:bg-yellow-900/30' :
