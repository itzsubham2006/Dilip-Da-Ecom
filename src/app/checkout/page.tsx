...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6] dark:bg-[#121212]">
      <div className="page-pad">
        <div className="container-z mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            <div className="lg:col-span-3 space-y-5">
              <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-zborder dark:border-[#2A2A2A] p-6">
                <h2 className="font-bold text-ztext mb-4 flex items-center gap-2">
                  <MapPin size={18} style={{ color: '#E23744' }} /> Delivery address
                </h2>
              ...
              <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-zborder dark:border-[#2A2A2A] p-6">
                <h2 className="font-bold text-ztext mb-4 flex items-center gap-2">
                  <CreditCard size={18} style={{ color: '#E23744' }} /> Payment method
                </h2>
                    ...
                    pm.id === 'bnpl' ? (
                      ...
                      <button key={pm.id} onClick={() => setPaymentMethod(pm.id)}
                        className={`w-full text-left p-4 rounded-xl border-2 transition-all flex items-start gap-3 ${
                          paymentMethod === pm.id
                            ? 'border-[#E23744] bg-red-50 dark:bg-red-950/20 shadow-sm'
                            : 'border-zborder dark:border-[#2A2A2A] hover:border-ztext-light hover:bg-gray-50 dark:hover:bg-[#252525]'
                        }`}>
                        ...
                        {paymentMethod === pm.id && (
                          <span className="ml-auto w-5 h-5 rounded-full bg-[#E23744] flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-[#1E1E1E] rounded-xl border border-zborder dark:border-[#2A2A2A] p-6 sticky top-24 shadow-sm">
                <h2 className="font-bold text-ztext mb-4 flex items-center gap-2">
                ...
                {error && <p className="text-xs mt-2 flex items-center gap-1" style={{ color: '#E23744' }}><span className="w-1.5 h-1.5 rounded-full bg-[#E23744]" />{error}</p>}
