...
const sections = [
  ...
  },
  {
    ...
    items: [
      { id: 'fish-1', name: 'Macher Jhol', price: 220, desc: 'Traditional Bengali fish curry with turmeric & ginger', veg: false, popular: true, img: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae7b0?w=400&h=400&fit=crop' },
      ...
      { id: 'fish-3', name: 'Fish Fry', price: 180, desc: 'Crispy fried fish fillet with salad & sauce', veg: false, popular: false, img: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae7b0?w=400&h=400&fit=crop' },
