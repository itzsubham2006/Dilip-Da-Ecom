...
export default function EditProductPage() {
  ...
  if (loading) return <div className="animate-pulse space-y-4"><div className="h-8 bg-gray-200 rounded w-48" /><div className="h-96 bg-gray-200 rounded-xl" /></div>;
  ...
  return (
    <div>
      ...
      <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Edit product</h1>
