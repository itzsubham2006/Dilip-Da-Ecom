  ...
  return (
    <div className="page-pad">
      <div className="container-z mx-auto max-w-lg text-center py-12">
        <div className="w-20 h-20 rounded-full bg-green-50 flex items-center justify-center mx-auto" style={{ color: '#24963F' }}>
          <CheckCircle size={40} />
        </div>
        ...
        <div className="bg-white rounded-xl shadow-z p-6 mt-8 text-left">
          <div className="flex items-center gap-3 text-sm">
            <Bike size={18} style={{ color: '#E23744' }} />
            <div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-8">
          ...
          <Link href="/restaurants" className="button-z button-z-outline flex-1 h-12">Order again</Link>
        </div>
      </div>
    </div>
  );
